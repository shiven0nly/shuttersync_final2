...
export default function ColorGradingWorkshopPage() {
  ...
  const handleDownload = async (filename: string) => {
    try {
      const response = await fetch(`/api/download-dng?file=${encodeURIComponent(filename)}`);
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-lg mb-8">
          ...
          <div className="aspect-video bg-gray-900 rounded-2xl mb-6 flex items-center justify-center">
            <p className="text-white text-sm">Video player will be embedded here</p>
          </div>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-lg mb-8">
          ...
          <div className="prose prose-sm max-w-none text-foreground/70">
            ...
            <ol className="list-decimal list-inside space-y-2 mb-4">
              ...
              <li>Submit the Drive link below</li>
            </ol>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-2xl font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
