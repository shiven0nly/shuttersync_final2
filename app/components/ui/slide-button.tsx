...
const SlideButton = forwardRef<HTMLButtonElement, SlideButtonProps>(
  ({ className, onSlideComplete, status: externalStatus, resetOnSuccess = false, ...props }, ref) => {
    ...
    }, [onSlideComplete, externalStatus, resetOnSuccess])
    ...
    return (
      <motion.div
        ...
        className="shadow-button-inset dark:shadow-button-inset-dark relative flex h-9 items-center justify-center rounded-full bg-gray-300 dark:bg-gray-700"
      >
        {!completed && (
          <motion.div
            style={{
            ...
            className="absolute inset-y-0 left-0 z-0 rounded-full bg-[#C4783E]"
          />
        )}
