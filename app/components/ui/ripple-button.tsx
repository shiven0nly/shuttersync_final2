...
export function RippleButton({ children, className = "", ...props }: RippleButtonProps) {
  ...
  return (
    <button
      ref={buttonRef}
      className={`relative flex items-center justify-center overflow-hidden rounded-full shadow-sm border border-dashed border-black/50 px-8 py-3 text-lg font-medium text-[#0e352e] transition-colors duration-[600ms] hover:text-white ${className}`}
      onMouseEnter={(e) => {
