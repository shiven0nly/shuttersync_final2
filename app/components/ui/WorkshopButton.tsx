...
export default function WorkshopButton({ label, href, disabled }: WorkshopButtonProps) {
  const content = (
    <button 
      className={`workshop-btn group ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
      disabled={disabled}
    >
      <div className="state">
        <div className="icon">
      ...
      <style jsx>{`
        ...
        .workshop-btn:not(:disabled):active {
        ...
        .workshop-btn:not(:disabled):hover p span {
          opacity: 1;
        ...
        .workshop-btn:not(:disabled):hover .icon {
