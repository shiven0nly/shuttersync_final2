                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                    ...
                    <div className="flex items-center gap-4">
                        <Link href="/admin/competitions">
                            <button className="px-6 py-3 bg-purple-500 text-white rounded-full text-sm font-semibold uppercase tracking-wider hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500/50 transition-colors flex items-center gap-2">
