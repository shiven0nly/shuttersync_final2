...
const upcomingFeatures = [
    ...
    },
    {
        id: 2,
        icon: 'CameraIcon',
        title: 'Photography Vision Workshop',
        description: 'Join Sachin Sudarsanan (@foto_sachy) to master the art of visual storytelling, outdoor travel, and raw street photography with any gear.',
        status: 'Open Now',
        color: 'from-purple-500/10 to-indigo-500/10',
        link: '/events/workshop/photography-vision',
    },
    {
        id: 3,
        icon: 'BookOpenIcon',
